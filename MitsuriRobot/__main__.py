...
───『 {} 』───
*Hey there {}!,*
* I am an advance group management bot with a lots of Features. My Anime theme is from Demon Slayer.  *
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 866830519:
            update.effective_message.reply_text(
                "I'm here for the Hashira Association 💌 I will help you also, just join"
                "[Hashira Association]({})".format(DONATION_LINK),
                parse_mode=ParseMode.MARKDOWN,
            )
    else:
        try:
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}", 
                "Heyaa Slayers , [Mitsuri](https://telegra.ph/file/3c530b329ca768ae77509.mp4) is awake again.",
                parse_mode=ParseMode.MARKDOWN
            )
        except Unauthorized:
            LOGGER.warning(
